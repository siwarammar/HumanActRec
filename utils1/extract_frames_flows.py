  ...
  for ic,cls in enumerate(class_list):
    ...
    for v in tqdm(vlist):
        ...
        try:  
            ...
            os.system('/home/ncrasto/code/workspace/action-recog-release/utils1/tvl1_videoframes "%s" %d "%s" '%( os.path.join(outdir, '%05d.jpg'), nframes, os.path.join(outdir,'%05d_flow256crop.flo') ))
